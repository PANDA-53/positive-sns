          ...
          <div className="space-y-8">
            ...
            <Suspense fallback={<div className="text-center py-10 text-gray-400">読み込み中...</div>}>
              <div className="space-y-6">
                {mainPosts.map((post) => (
                  <div key={post.id} className="bg-white rounded-[2rem] shadow-sm border border-gray-100 p-5 md:p-7 animate-in fade-in slide-in-from-bottom-3 duration-300">
                          ...
                          <div key={reply.id} className="text-sm md:text-base bg-gray-50 p-3 rounded-2xl">
                            <div className="flex items-center gap-2 mb-1">
                                <div className="w-5 h-5 rounded-full overflow-hidden shrink-0">
                                    <img src={reply.profiles?.avatar_url || defaultAvatar} className="w-full h-full object-cover" />
                                </div>
